# [SevTech: Ages - 3.2.0](https://www.curseforge.com/minecraft/modpacks/sevtech-ages) on Curseforge
...
The docker on first run will download the same version as tagged of `SevTech: Ages - 3.2.0` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "SevTech: Ages - 3.2.0 Server Powered by Docker"
* LEVEL world
...
## Source
Github: https://github.com/Goobaroo/docker-sevtechages

Docker: https://hub.docker.com/repository/docker/goobaroo/sevtechages